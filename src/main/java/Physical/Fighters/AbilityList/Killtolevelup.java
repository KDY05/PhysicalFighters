    ...
    public int A_Condition(Event event, int CustomData) {
        switch (CustomData) {
            case 0:
                ...
                if ((PlayerCheck(Event.getDamager())) && (ItemCheck(Material.FEATHER)))
                    return 0;
                break;
            case 1:
            ...
            case 3:
                ...
                if ((Event3.getEntity().getKiller() != null) &&
                        (PlayerCheck(Event3.getEntity().getKiller())) && (ItemCheck(Material.FEATHER)) && ((Event3.getEntity() instanceof Player)))
                    return 4;
                break;
        }
        return -1;

    ...
    public int A_Condition(Event event, int CustomData) {
        switch (CustomData) {
            case 0:
                ...
                if ((PlayerCheck(Event.getPlayer())) && (ItemCheck(Physical.Fighters.MinerModule.ACC.DefaultItem)) && !EventManager.DamageGuard) {
                    return 0;
                }
                break;
            case 1:
                BlockPlaceEvent Event1 = (BlockPlaceEvent) event;
                if ((PlayerCheck(Event1.getPlayer())) && (Event1.getBlock().getType() == Material.SOUL_SAND)) {
                    return 1;
                }
                break;
            case 3:
                PlayerDropItemEvent Event3 = (PlayerDropItemEvent) event;
                if ((PlayerCheck(Event3.getPlayer())) &&
            ...
            case 4:
                ...
                if (PlayerCheck(Event4.getPlayer()))
                    return 4;
                break;
            case 5:
            ...
            case 6:
                ...
                if ((PlayerCheck(Event6.getPlayer())) && (Event6.getBlock().getType() == Material.SOUL_SAND)) {
                    return 6;
                }
                break;
        }

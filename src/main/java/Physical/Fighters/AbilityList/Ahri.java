...
public class Ahri extends AbilityBase {
    public Ahri() {
        if (Physical.Fighters.PhysicalFighters.SRankUsed) {
            InitAbility("아리", Type.Active_Immediately, Rank.SS, new String[]{
    ...
    public void A_Effect(Event event, int CustomData) {
        switch (CustomData) {
            case 0:
                ...
                Location pl = GetPlayer().getLocation();
                Location tl = pe.getLocation();
